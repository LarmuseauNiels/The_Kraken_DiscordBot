            ...
            request("http://query.li/api/eco/"+ecoconfig.serverip+'/'+ecoconfig.serverport, (err, res, body) => {
                ...
                try {
                    ...
                    if(contents.status.error){
                        statuschannel.send(contents.status.message)
                    }
                    else{
                        ...
                        embed.addField("Players online", contents.game.info.player_count ,false);
                        ...
                        console.log(err);
                        //statuschannel.sendMessage("ERR :disappointed:");
                };
            });  
        }, 30000); 
    }
